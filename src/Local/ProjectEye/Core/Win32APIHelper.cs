    ...
    public class Win32APIHelper
    {
        ...
        public static WindowInfo GetFocusWindowInfo()
        {
            ...
            try
            {
                ...
                //浏览器全屏判断
                if (!string.IsNullOrEmpty(result.ClassName) && result.ClassName.ToLower().IndexOf("chrome_widgetwin") != -1)
                {
            ...
            {
                LogHelper.Error("Win32APIHelper.GetFocusWindowInfo: " + ex.ToString());
            }
            return result;
        }
        #endregion
