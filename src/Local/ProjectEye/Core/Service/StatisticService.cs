    ...
    public class StatisticService : IService
    {
        ...
        public void Add(StatisticType type, double value)
        {
            if (todayStatistic == null)
            {
                ...
                {
                    LogHelper.Error("StatisticService.Add.FindCreate: " + ex.ToString());
                    return;
                }
            }
            if (todayStatistic == null)
            ...
            if (todayStatistic.Date.Date != DateTime.Now.Date)
            {
        ...
        public void StatisticUseEyeData()
        {
            lock (statisticLocker)
            {
                ...
                {
                    LogHelper.Error("StatisticService.StatisticUseEyeData: " + ex.ToString());
                }
                //重置统计时间
                ResetStatisticTime();
            }
