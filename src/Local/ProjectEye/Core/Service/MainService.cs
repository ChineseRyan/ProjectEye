...
namespace ProjectEye.Core.Service
{
    ...
    public class MainService : IService
    {
        ...
        private void HandleLanguageChanged()
        {
            ...
            {
                LogHelper.Error("MainService.HandleLanguageChanged: " + ex.ToString());
            }
        }
        ...
        private void busy_timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("MainService.busy_timer_Tick: " + ex.ToString());
            }
        }
        ...
        private void date_timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("MainService.date_timer_Tick: " + ex.ToString());
            }
        }
        ...
        private void useeye_timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("MainService.useeye_timer_Tick: " + ex.ToString());
            }
        }
        #endregion
        ...
        private void isVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                LogHelper.Error("MainService.isVisibleChanged: " + ex.ToString());
            }
        }
        #endregion
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("MainService.timer_Tick: " + ex.ToString());
            }
        }
        #endregion
        ...
        public bool IsBreakReset()
        {
            ...
            {
                LogHelper.Error("MainService.IsBreakReset: " + ex.ToString());
                return false;
            }
        }
        #endregion
