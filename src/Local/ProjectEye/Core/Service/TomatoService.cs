...
namespace ProjectEye.Core.Service
{
    ...
    public class TomatoService : IService
    {
        ...
        private void WorkTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (workCount == 4)
                {
                    ...
                    //  判断时间更新
                    if (tomatoDataToday != null && tomatoDataToday.Date != DateTime.Now.Date)
                    {
                        //  先保存未更新日期的数据
                        SaveData();
            ...
            {
                LogHelper.Error("TomatoService.WorkTimer_Tick: " + ex.ToString());
                try { workTimer.Stop(); } catch { }
            }
        }
        private void RestTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("TomatoService.RestTimer_Tick: " + ex.ToString());
        ...
        private void Tray_MouseMoveTrayIcon(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            {
                LogHelper.Error("TomatoService.Tray_MouseMoveTrayIcon: " + ex.ToString());
            }
        }
        ...
        private void icorefreshTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                LogHelper.Error("TomatoService.icorefreshTimer_Tick: " + ex.ToString());
            }
        }
        ...
        public void SaveData()
        {
            backgroundWorker.AddAction(() =>
            {
                ...
                {
                    LogHelper.Error("TomatoService.SaveData: " + ex.ToString());
                }
            });
            backgroundWorker.Run();
        }
