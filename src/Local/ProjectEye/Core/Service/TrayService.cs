...
namespace ProjectEye.Core.Service
{
    ...
    public class TrayService : IService
    {
        ...
        private bool noresetTimerHandlerAttached = false;
        ...
        private void NotifyIcon_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            {
                LogHelper.Error("TrayService.NotifyIcon_MouseMove: " + ex.ToString());
            }
        }
        ...
        private void config_Changed(object sender, EventArgs e)
        {
            try
            {
                ...
                if (oldOptions != null && oldOptions.General.IsTomatoMode != config.options.General.IsTomatoMode)
                {
            ...
            {
                LogHelper.Error("TrayService.config_Changed: " + ex.ToString());
            }
        }
        ...
        private void notifyIcon_MouseClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            {
                LogHelper.Error("TrayService.notifyIcon_MouseClick: " + ex.ToString());
            }
        }
        ...
        private void NotifyIcon_MouseDoubleClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            {
                LogHelper.Error("TrayService.NotifyIcon_MouseDoubleClick: " + ex.ToString());
            }
        }
        #endregion
        ...
        public void UpdateIcon(string name = "", bool save = true)
        {
            try
            {
                ...
                if (notifyIcon != null && name != "")
                {
                    ...
                    {
                        LogHelper.Warning($"UpdateIcon: 找不到图标资源 {name}.ico");
                    }
                }
            }
            catch (Exception ex)
            {
                LogHelper.Error("TrayService.UpdateIcon: " + ex.ToString());
            }
        }
        /// <summary>
        /// 设置不提醒操作
        ...
        private void SetNoReset(int hour)
        {
            try
            {
                ...
                if (menuItem_NoReset_OneHour != null) menuItem_NoReset_OneHour.IsChecked = false;
                if (menuItem_NoReset_TwoHour != null) menuItem_NoReset_TwoHour.IsChecked = false;
                if (menuItem_NoReset_Forver != null) menuItem_NoReset_Forver.IsChecked = false;
                if (menuItem_NoReset_Off != null) menuItem_NoReset_Off.IsChecked = false;
                if (menuItem_NoReset != null) menuItem_NoReset.IsChecked = true;
                noresetTimer.Stop();
                UpdateIcon("dizzy");
                if (hour == -1)
                {
                    ...
                    if (menuItem_NoReset != null) menuItem_NoReset.IsChecked = false;
                    mainService.Start();
                    UpdateIcon("sunglasses");
                ...
                else
                {
                    ...
                    // 避免重复注册 Tick 事件
                    if (!noresetTimerHandlerAttached)
                    {
                        noresetTimer.Tick += noresetTimer_Tick;
                        noresetTimerHandlerAttached = true;
                    }
                    noresetTimer.Start();
                }
            }
            ...
            {
                LogHelper.Error("TrayService.SetNoReset: " + ex.ToString());
            }
        }
        ...
        private void noresetTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                noresetTimer.Stop();
                SetNoReset(-1);
                if (menuItem_NoReset_Off != null)
                    menuItem_NoReset_Off.IsChecked = true;
            }
            catch (Exception ex)
            {
                LogHelper.Error("TrayService.noresetTimer_Tick: " + ex.ToString());
            }
        }
